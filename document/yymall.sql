/*
 ...
 Source Host           : rm-uf664qjgc068ae1fzro.mysql.rds.aliyuncs.com:3306
 Source Schema         : yymall

 Target Server Type    : MySQL
 Target Server Version : 80016
 File Encoding         : 65001

 Date: 14/09/2020 10:37:10
*/
...
-- ----------------------------
INSERT INTO `backend_admin` VALUES (1, 'test', '$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'test@qq.com', '测试账号', NULL, '2018-09-29 13:55:30', '2018-09-29 13:55:39', 1);
INSERT INTO `backend_admin` VALUES (3, 'admin', '$2a$10$.E1FokumK5GIXWgKlg.Hc.i/0/2.qdAwYFL1zc5QHdyzpXOr38RZO', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-20 12:45:16', 1);
INSERT INTO `backend_admin` VALUES (4, 'macro', '$2a$10$Bx4jZPR7GhEpIQfefDQtVeS58GfT5n6mxs/b4nLLK65eMFa16topa', 'string', 'macro@qq.com', 'macro', 'macro专用', '2019-10-06 15:53:51', '2020-02-03 14:55:55', 1);
INSERT INTO `backend_admin` VALUES (6, 'productAdmin', '$2a$10$6/.J.p.6Bhn7ic4GfoB5D.pGd7xSiD1a9M6ht6yO0fxzlKJPjRAGm', NULL, 'product@qq.com', '商品管理员', '只有商品权限', '2020-02-07 16:15:08', NULL, 1);
INSERT INTO `backend_admin` VALUES (7, 'orderAdmin', '$2a$10$UqEhA9UZXjHHA3B.L9wNG.6aerrBjC6WHTtbv1FdvYPUI.7lkL6E.', NULL, 'order@qq.com', '订单管理员', '只有订单管理权限', '2020-02-07 16:15:50', NULL, 1);

-- ----------------------------
-- Table structure for backend_admin_role_relation
-- ----------------------------
DROP TABLE IF EXISTS `backend_admin_role_relation`;
CREATE TABLE `backend_admin_role_relation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of backend_admin_role_relation
-- ----------------------------
INSERT INTO `backend_admin_role_relation` VALUES (26, 3, 5);
INSERT INTO `backend_admin_role_relation` VALUES (27, 6, 1);
INSERT INTO `backend_admin_role_relation` VALUES (28, 7, 2);
INSERT INTO `backend_admin_role_relation` VALUES (29, 1, 5);
INSERT INTO `backend_admin_role_relation` VALUES (30, 4, 5);
...
-- ----------------------------
INSERT INTO `backend_menu` VALUES (1, 0, '2020-02-02 14:50:36', '商品', 0, 0, 'pms', 'product', 0);
INSERT INTO `backend_menu` VALUES (2, 1, '2020-02-02 14:51:50', '商品列表', 1, 0, 'product', 'product-list', 0);
INSERT INTO `backend_menu` VALUES (3, 1, '2020-02-02 14:52:44', '添加商品', 1, 0, 'addProduct', 'product-add', 0);
INSERT INTO `backend_menu` VALUES (4, 1, '2020-02-02 14:53:51', '商品分类', 1, 0, 'productCate', 'product-cate', 0);
INSERT INTO `backend_menu` VALUES (5, 1, '2020-02-02 14:54:51', '商品类型', 1, 0, 'productAttr', 'product-attr', 0);
INSERT INTO `backend_menu` VALUES (6, 1, '2020-02-02 14:56:29', '品牌管理', 1, 0, 'brand', 'product-brand', 0);
INSERT INTO `backend_menu` VALUES (7, 0, '2020-02-02 16:54:07', '订单', 0, 0, 'oms', 'order', 0);
INSERT INTO `backend_menu` VALUES (8, 7, '2020-02-02 16:55:18', '订单列表', 1, 0, 'order', 'product-list', 0);
INSERT INTO `backend_menu` VALUES (9, 7, '2020-02-02 16:56:46', '订单设置', 1, 0, 'orderSetting', 'order-setting', 0);
INSERT INTO `backend_menu` VALUES (10, 7, '2020-02-02 16:57:39', '退货申请处理', 1, 0, 'returnApply', 'order-return', 0);
INSERT INTO `backend_menu` VALUES (11, 7, '2020-02-02 16:59:40', '退货原因设置', 1, 0, 'returnReason', 'order-return-reason', 0);
INSERT INTO `backend_menu` VALUES (12, 0, '2020-02-04 16:18:00', '营销', 0, 0, 'sms', 'sms', 0);
INSERT INTO `backend_menu` VALUES (13, 12, '2020-02-04 16:19:22', '秒杀活动列表', 1, 0, 'flash', 'sms-flash', 0);
INSERT INTO `backend_menu` VALUES (14, 12, '2020-02-04 16:20:16', '优惠券列表', 1, 0, 'coupon', 'sms-coupon', 0);
INSERT INTO `backend_menu` VALUES (16, 12, '2020-02-07 16:22:38', '品牌推荐', 1, 0, 'homeBrand', 'product-brand', 0);
INSERT INTO `backend_menu` VALUES (17, 12, '2020-02-07 16:23:14', '新品推荐', 1, 0, 'homeNew', 'sms-new', 0);
INSERT INTO `backend_menu` VALUES (18, 12, '2020-02-07 16:26:38', '人气推荐', 1, 0, 'homeHot', 'sms-hot', 0);
INSERT INTO `backend_menu` VALUES (19, 12, '2020-02-07 16:28:16', '专题推荐', 1, 0, 'homeSubject', 'sms-subject', 0);
INSERT INTO `backend_menu` VALUES (20, 12, '2020-02-07 16:28:42', '广告列表', 1, 0, 'homeAdvertise', 'sms-ad', 0);
INSERT INTO `backend_menu` VALUES (21, 0, '2020-02-07 16:29:13', '权限', 0, 0, 'ums', 'ums', 0);
INSERT INTO `backend_menu` VALUES (22, 21, '2020-02-07 16:29:51', '用户列表', 1, 0, 'admin', 'ums-admin', 0);
INSERT INTO `backend_menu` VALUES (23, 21, '2020-02-07 16:30:13', '角色列表', 1, 0, 'role', 'ums-role', 0);
INSERT INTO `backend_menu` VALUES (24, 21, '2020-02-07 16:30:53', '菜单列表', 1, 0, 'menu', 'ums-menu', 0);
INSERT INTO `backend_menu` VALUES (25, 21, '2020-02-07 16:31:13', '资源列表', 1, 0, 'resource', 'ums-resource', 0);

-- ----------------------------
-- Table structure for backend_resource
-- ----------------------------
DROP TABLE IF EXISTS `backend_resource`;
CREATE TABLE `backend_resource`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Records of backend_resource
-- ----------------------------
INSERT INTO `backend_resource` VALUES (1, '2020-02-04 17:04:55', '商品品牌管理', '/brand/**', NULL, 1);
INSERT INTO `backend_resource` VALUES (2, '2020-02-04 17:05:35', '商品属性分类管理', '/productAttribute/**', NULL, 1);
INSERT INTO `backend_resource` VALUES (3, '2020-02-04 17:06:13', '商品属性管理', '/productAttribute/**', NULL, 1);
INSERT INTO `backend_resource` VALUES (4, '2020-02-04 17:07:15', '商品分类管理', '/productCategory/**', NULL, 1);
INSERT INTO `backend_resource` VALUES (5, '2020-02-04 17:09:16', '商品管理', '/product/**', NULL, 1);
INSERT INTO `backend_resource` VALUES (6, '2020-02-04 17:09:53', '商品库存管理', '/sku/**', NULL, 1);
INSERT INTO `backend_resource` VALUES (8, '2020-02-05 14:43:37', '订单管理', '/order/**', '', 2);
INSERT INTO `backend_resource` VALUES (9, '2020-02-05 14:44:22', '订单退货申请管理', '/returnApply/**', '', 2);
INSERT INTO `backend_resource` VALUES (10, '2020-02-05 14:45:08', '退货原因管理', '/returnReason/**', '', 2);
INSERT INTO `backend_resource` VALUES (11, '2020-02-05 14:45:43', '订单设置管理', '/orderSetting/**', '', 2);
INSERT INTO `backend_resource` VALUES (12, '2020-02-05 14:46:23', '收货地址管理', '/companyAddress/**', '', 2);
INSERT INTO `backend_resource` VALUES (13, '2020-02-07 16:37:22', '优惠券管理', '/coupon/**', '', 3);
INSERT INTO `backend_resource` VALUES (14, '2020-02-07 16:37:59', '优惠券领取记录管理', '/couponHistory/**', '', 3);
INSERT INTO `backend_resource` VALUES (15, '2020-02-07 16:38:28', '限时购活动管理', '/flash/**', '', 3);
INSERT INTO `backend_resource` VALUES (16, '2020-02-07 16:38:59', '限时购商品关系管理', '/flashProductRelation/**', '', 3);
INSERT INTO `backend_resource` VALUES (17, '2020-02-07 16:39:22', '限时购场次管理', '/flashSession/**', '', 3);
INSERT INTO `backend_resource` VALUES (18, '2020-02-07 16:40:07', '首页轮播广告管理', '/home/advertise/**', '', 3);
INSERT INTO `backend_resource` VALUES (19, '2020-02-07 16:40:34', '首页品牌管理', '/home/brand/**', '', 3);
INSERT INTO `backend_resource` VALUES (20, '2020-02-07 16:41:06', '首页新品管理', '/home/newProduct/**', '', 3);
INSERT INTO `backend_resource` VALUES (21, '2020-02-07 16:42:16', '首页人气推荐管理', '/home/recommendProduct/**', '', 3);
INSERT INTO `backend_resource` VALUES (22, '2020-02-07 16:42:48', '首页专题推荐管理', '/home/recommendSubject/**', '', 3);
INSERT INTO `backend_resource` VALUES (23, '2020-02-07 16:44:56', '商品优选管理', '/prefrenceArea/**', '', 5);
INSERT INTO `backend_resource` VALUES (24, '2020-02-07 16:45:39', '商品专题管理', '/subject/**', '', 5);
INSERT INTO `backend_resource` VALUES (25, '2020-02-07 16:47:34', '后台用户管理', '/admin/**', '', 4);
INSERT INTO `backend_resource` VALUES (26, '2020-02-07 16:48:24', '后台用户角色管理', '/role/**', '', 4);
INSERT INTO `backend_resource` VALUES (27, '2020-02-07 16:48:48', '后台菜单管理', '/menu/**', '', 4);
INSERT INTO `backend_resource` VALUES (28, '2020-02-07 16:49:18', '后台资源分类管理', '/resourceCategory/**', '', 4);
INSERT INTO `backend_resource` VALUES (29, '2020-02-07 16:49:45', '后台资源管理', '/resource/**', '', 4);

-- ----------------------------
-- Table structure for backend_resource_category
-- ----------------------------
DROP TABLE IF EXISTS `backend_resource_category`;
CREATE TABLE `backend_resource_category`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Records of backend_resource_category
-- ----------------------------
INSERT INTO `backend_resource_category` VALUES (1, '2020-02-05 10:21:44', '商品模块', 0);
INSERT INTO `backend_resource_category` VALUES (2, '2020-02-05 10:22:34', '订单模块', 0);
INSERT INTO `backend_resource_category` VALUES (3, '2020-02-05 10:22:48', '营销模块', 0);
INSERT INTO `backend_resource_category` VALUES (4, '2020-02-05 10:23:04', '权限模块', 0);
INSERT INTO `backend_resource_category` VALUES (5, '2020-02-07 16:34:27', '内容模块', 0);
INSERT INTO `backend_resource_category` VALUES (6, '2020-02-07 16:35:49', '其他模块', 0);
...
-- ----------------------------
INSERT INTO `backend_role` VALUES (1, '商品管理员', '只能查看及操作商品', 0, '2020-02-03 16:50:37', 1, 0);
INSERT INTO `backend_role` VALUES (2, '订单管理员', '只能查看及操作订单', 0, '2018-09-30 15:53:45', 1, 0);
INSERT INTO `backend_role` VALUES (5, '超级管理员', '拥有所有查看和操作功能', 0, '2020-02-02 15:11:05', 1, 0);

-- ----------------------------
-- Table structure for backend_role_menu_relation
-- ----------------------------
DROP TABLE IF EXISTS `backend_role_menu_relation`;
CREATE TABLE `backend_role_menu_relation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of backend_role_menu_relation
-- ----------------------------
INSERT INTO `backend_role_menu_relation` VALUES (33, 1, 1);
INSERT INTO `backend_role_menu_relation` VALUES (34, 1, 2);
INSERT INTO `backend_role_menu_relation` VALUES (35, 1, 3);
INSERT INTO `backend_role_menu_relation` VALUES (36, 1, 4);
INSERT INTO `backend_role_menu_relation` VALUES (37, 1, 5);
INSERT INTO `backend_role_menu_relation` VALUES (38, 1, 6);
INSERT INTO `backend_role_menu_relation` VALUES (53, 2, 7);
INSERT INTO `backend_role_menu_relation` VALUES (54, 2, 8);
INSERT INTO `backend_role_menu_relation` VALUES (55, 2, 9);
INSERT INTO `backend_role_menu_relation` VALUES (56, 2, 10);
INSERT INTO `backend_role_menu_relation` VALUES (57, 2, 11);
INSERT INTO `backend_role_menu_relation` VALUES (72, 5, 1);
INSERT INTO `backend_role_menu_relation` VALUES (73, 5, 2);
INSERT INTO `backend_role_menu_relation` VALUES (74, 5, 3);
INSERT INTO `backend_role_menu_relation` VALUES (75, 5, 4);
INSERT INTO `backend_role_menu_relation` VALUES (76, 5, 5);
INSERT INTO `backend_role_menu_relation` VALUES (77, 5, 6);
INSERT INTO `backend_role_menu_relation` VALUES (78, 5, 7);
INSERT INTO `backend_role_menu_relation` VALUES (79, 5, 8);
INSERT INTO `backend_role_menu_relation` VALUES (80, 5, 9);
INSERT INTO `backend_role_menu_relation` VALUES (81, 5, 10);
INSERT INTO `backend_role_menu_relation` VALUES (82, 5, 11);
INSERT INTO `backend_role_menu_relation` VALUES (83, 5, 12);
INSERT INTO `backend_role_menu_relation` VALUES (84, 5, 13);
INSERT INTO `backend_role_menu_relation` VALUES (85, 5, 14);
INSERT INTO `backend_role_menu_relation` VALUES (86, 5, 16);
INSERT INTO `backend_role_menu_relation` VALUES (87, 5, 17);
INSERT INTO `backend_role_menu_relation` VALUES (88, 5, 18);
INSERT INTO `backend_role_menu_relation` VALUES (89, 5, 19);
INSERT INTO `backend_role_menu_relation` VALUES (90, 5, 20);
INSERT INTO `backend_role_menu_relation` VALUES (91, 5, 21);
INSERT INTO `backend_role_menu_relation` VALUES (92, 5, 22);
INSERT INTO `backend_role_menu_relation` VALUES (93, 5, 23);
INSERT INTO `backend_role_menu_relation` VALUES (94, 5, 24);
INSERT INTO `backend_role_menu_relation` VALUES (95, 5, 25);

-- ----------------------------
-- Table structure for backend_role_resource_relation
-- ----------------------------
DROP TABLE IF EXISTS `backend_role_resource_relation`;
CREATE TABLE `backend_role_resource_relation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `role_id` bigint(20) NULL DEFAULT NULL COMMENT '角色ID',
...
-- ----------------------------
-- Records of backend_role_resource_relation
-- ----------------------------
INSERT INTO `backend_role_resource_relation` VALUES (103, 2, 8);
INSERT INTO `backend_role_resource_relation` VALUES (104, 2, 9);
INSERT INTO `backend_role_resource_relation` VALUES (105, 2, 10);
INSERT INTO `backend_role_resource_relation` VALUES (106, 2, 11);
INSERT INTO `backend_role_resource_relation` VALUES (107, 2, 12);
INSERT INTO `backend_role_resource_relation` VALUES (142, 5, 1);
INSERT INTO `backend_role_resource_relation` VALUES (143, 5, 2);
INSERT INTO `backend_role_resource_relation` VALUES (144, 5, 3);
INSERT INTO `backend_role_resource_relation` VALUES (145, 5, 4);
INSERT INTO `backend_role_resource_relation` VALUES (146, 5, 5);
INSERT INTO `backend_role_resource_relation` VALUES (147, 5, 6);
INSERT INTO `backend_role_resource_relation` VALUES (148, 5, 8);
INSERT INTO `backend_role_resource_relation` VALUES (149, 5, 9);
INSERT INTO `backend_role_resource_relation` VALUES (150, 5, 10);
INSERT INTO `backend_role_resource_relation` VALUES (151, 5, 11);
INSERT INTO `backend_role_resource_relation` VALUES (152, 5, 12);
INSERT INTO `backend_role_resource_relation` VALUES (153, 5, 13);
INSERT INTO `backend_role_resource_relation` VALUES (154, 5, 14);
INSERT INTO `backend_role_resource_relation` VALUES (155, 5, 15);
INSERT INTO `backend_role_resource_relation` VALUES (156, 5, 16);
INSERT INTO `backend_role_resource_relation` VALUES (157, 5, 17);
INSERT INTO `backend_role_resource_relation` VALUES (158, 5, 18);
INSERT INTO `backend_role_resource_relation` VALUES (159, 5, 19);
INSERT INTO `backend_role_resource_relation` VALUES (160, 5, 20);
INSERT INTO `backend_role_resource_relation` VALUES (161, 5, 21);
INSERT INTO `backend_role_resource_relation` VALUES (162, 5, 22);
INSERT INTO `backend_role_resource_relation` VALUES (163, 5, 23);
INSERT INTO `backend_role_resource_relation` VALUES (164, 5, 24);
INSERT INTO `backend_role_resource_relation` VALUES (165, 5, 25);
INSERT INTO `backend_role_resource_relation` VALUES (166, 5, 26);
INSERT INTO `backend_role_resource_relation` VALUES (167, 5, 27);
INSERT INTO `backend_role_resource_relation` VALUES (168, 5, 28);
INSERT INTO `backend_role_resource_relation` VALUES (169, 5, 29);
INSERT INTO `backend_role_resource_relation` VALUES (170, 1, 1);
INSERT INTO `backend_role_resource_relation` VALUES (171, 1, 2);
INSERT INTO `backend_role_resource_relation` VALUES (172, 1, 3);
INSERT INTO `backend_role_resource_relation` VALUES (173, 1, 4);
INSERT INTO `backend_role_resource_relation` VALUES (174, 1, 5);
INSERT INTO `backend_role_resource_relation` VALUES (175, 1, 6);
INSERT INTO `backend_role_resource_relation` VALUES (176, 1, 23);
INSERT INTO `backend_role_resource_relation` VALUES (177, 1, 24);
...
CREATE TABLE `carousel`  (
  ...
  `background_color` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '背景色 背景颜色',
  ...
  `type` int(10) NOT NULL COMMENT '轮播图类型 轮播图类型，用于判断，可以根据商品id或者分类进行页面跳转，1：商品 2：分类',
  `sort` int(10) NOT NULL COMMENT '轮播图展示顺序 轮播图展示顺序，从小到大',
  `is_show` int(10) NOT NULL COMMENT '是否展示 是否展示，1：展示    0：不展示',
...
CREATE TABLE `category`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键 分类id主键',
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '分类名称 分类名称',
  `type` int(10) NOT NULL COMMENT '分类类型 分类得类型，\n1:一级大分类\n2:二级分类\n3:三级小分类',
  `father_id` int(10) NOT NULL COMMENT '父id 父id 上一级依赖的id，1级分类则为0，二级三级分别依赖上一级',
...
CREATE TABLE `items`  (
  ...
  `cat_id` int(10) NOT NULL COMMENT '分类外键id 分类id',
  `root_cat_id` int(10) NOT NULL COMMENT '一级分类外键id 一级分类id，用于优化查询',
  `sell_counts` int(10) NOT NULL COMMENT '累计销售 累计销售',
  `on_off_status` int(10) NOT NULL COMMENT '上下架状态 上下架状态,1:上架 2:下架',
...
CREATE TABLE `items_img`  (
  ...
  `sort` int(10) NOT NULL COMMENT '顺序 图片顺序，从小到大',
  `is_main` int(10) NOT NULL COMMENT '是否主图 是否主图，1：是，0：否',
  `created_time` datetime(0) NOT NULL COMMENT '创建时间',
  `updated_time` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `pdman_db_version` VALUES ('v0.0.0', '默认版本，新增的版本不能低于此版本', '2020-09-04 21:43:16');
INSERT INTO `pdman_db_version` VALUES ('0.1.0', '添加权限相关表', '2020-09-09 22:12:34');
INSERT INTO `pdman_db_version` VALUES ('0.1.1', '更新表结构', '2020-09-13 22:21:07');
...
CREATE TABLE `user_address`  (
  ...
  `is_default` int(10) NULL DEFAULT NULL COMMENT '是否默认地址',
  `created_time` datetime(0) NOT NULL COMMENT '创建时间',
  `updated_time` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `users`  (
  ...
  `sex` int(10) NULL DEFAULT NULL COMMENT '性别 性别 1:男  0:女  2:保密',
